...
!(function (global, setTimeout) {
    ...
    if (void 0 === define) {
        ...
        void 0 === require || isFunction(require) || ((cfg = require), (require = void 0)),
            ...
            (req.load = function (t, i, r) {
                ...
                if (isBrowser)
                    return (
                        (e = req.createNode(n, i, r)).setAttribute("data-requirecontext", t.contextName),
                        e.setAttribute("data-requiremodule", i),
                        !e.attachEvent || (e.attachEvent.toString && e.attachEvent.toString().indexOf("[native code") < 0) || isOpera
                            ? (e.addEventListener("load", t.onScriptLoad, !1), e.addEventListener("error", t.onScriptError, !1))
                            : ((useInteractive = !0), e.attachEvent("onreadystatechange", t.onScriptLoad)),
                        (e.src = r),
            ...
            (define = function (e, i, t) {
                ...
                "string" != typeof e && ((t = i), (i = e), (e = null)),
                    ...
                    n ? (n.defQueue.push([e, i, t]), (n.defQueueMap[e] = !0)) : globalDefQueue.push([e, i, t]);
            }),
            (define.amd = { jQuery: !0 }),
    ...
    function newContext(u) {
        var i,
            ...
            c,
            d,
            g = { waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} },
            p = {},
            f = {},
            r = {},
            h = [],
                ...
                e &&
                    (u
                        ? (f = i
                              ...
                              ? q(e, c, r)
                              : e)
                        : ((u = (s = y((f = q(e, c, r))))[0]), (f = s[1]), (i = !0), (n = l.nameToUrl(f)))),
                { prefix: u, name: f, parentMap: t, unnormalized: !!(a = !u || o || i ? "" : "_unnormalized" + (b += 1)), url: n, originalName: d, isDefine: p, id: (u ? u + "!" + f : f) + a }
            );
        }
        function k(e) {
            var t = e.id,
        ...
        function s(e) {
            ...
            return o(t, l.onScriptLoad, "load", "onreadystatechange"), o(t, l.onScriptError, "error"), { node: t, id: t && t.getAttribute("data-requiremodule") };
        }
        function T() {
            var e;
            for (j(); h.length; ) {
            ...
            ((l = {
                ...
                makeRequire: function (o, a) {
                    function s(e, t, i) {
                        var r, n;
                        return (
                            a.enableBuildCallback && t && isFunction(t) && (t.__requireJsBuild = !0),
                            "string" == typeof e
                                ? isFunction(t)
                                    ...
                                    : req.get
                                    ? req.get(l, e, o, s)
                                    : ((r = S(e, o, !1, !0).id), hasProp(m, r) ? m[r] : O(makeError("notloaded", 'Module name "' + r + '" has not been loaded yet for context: ' + u + (o ? "" : ". Use require([])"))))
                                : (T(),
                                  l.nextTick(function () {
