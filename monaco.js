 ...
 var h = (function () {
     ...
     return (
         (a.prototype.record = function (n, p) {
             this._events.push(new E(n, p, f.Utilities.getHighPerformanceTimestamp()));
         }),
...
(function (f) {
 var E = (function () {
     function h() {}
     return (
         (h.fileUriToFilePath = function (g, a) {
         ...
         (h.startsWith = function (g, a) {
             return g.length >= a.length && g.substr(0, a.length) === a;
         }),
         (h.endsWith = function (g, a) {
             return g.length >= a.length && g.substr(g.length - a.length) === a;
         }),
         (h.containsQueryString = function (g) {
             return /^[^\#]*\?/gi.test(g);
         }),
         (h.isAbsolutePath = function (g) {
             return /^((http:\/\/)|(https:\/\/)|(file:\/\/)|(\/))/.test(g);
         }),
         (h.forEachProperty = function (g, a) {
             if (g) {
                 var n = void 0;
         ...
         (h.isEmpty = function (g) {
             var a = !0;
             return (
                 h.forEachProperty(g, function () {
                     a = !1;
                 }),
                 a
             );
         }),
         (h.recursiveClone = function (g) {
             ...
             return (
                 h.forEachProperty(g, function (n, p) {
                     p && typeof p == "object" ? (a[n] = h.recursiveClone(p)) : (a[n] = p);
                 }),
                 a
             );
         }),
         ...
         (h.isAnonymousModule = function (g) {
             return h.startsWith(g, "===anonymous");
         }),
         (h.getHighPerformanceTimestamp = function () {
             return (
                 this.PERFORMANCE_NOW_PROBED || ((this.PERFORMANCE_NOW_PROBED = !0), (this.HAS_PERFORMANCE_NOW = f.global.performance && typeof f.global.performance.now == "function")),
...
(function (f) {
     ...
     return (
         (a.validateConfigurationOptions = function (n) {
             ...
             if (
                 ...
                 n.baseUrl.length > 0 && (f.Utilities.endsWith(n.baseUrl, "/") || (n.baseUrl += "/")),
                 ...
                 n.nodeCachedData &&
                     ...
                     (typeof n.nodeCachedData.seed != "string" && (n.nodeCachedData.seed = "seed"),
                     (typeof n.nodeCachedData.writeDelay != "number" || n.nodeCachedData.writeDelay < 0) && (n.nodeCachedData.writeDelay = 1e3 * 7),
                     !n.nodeCachedData.path || typeof n.nodeCachedData.path != "string"))
             ) {
                 var r = E(new Error("INVALID cached data configuration, 'path' MUST be set"));
         ...
         (a.mergeConfigurationOptions = function (n, p) {
             ...
             var r = f.Utilities.recursiveClone(p || {});
             return (
                 f.Utilities.forEachProperty(n, function (e, t) {
                     e === "ignoreDuplicateModules" && typeof r.ignoreDuplicateModules != "undefined"
                         ? (r.ignoreDuplicateModules = r.ignoreDuplicateModules.concat(t))
                         : e === "paths" && typeof r.paths != "undefined"
                         ? f.Utilities.forEachProperty(t, function (i, o) {
                               return (r.paths[i] = o);
                           })
                         ...
                         : (r[e] = f.Utilities.recursiveClone(t));
                 }),
 ...
 f.ConfigurationOptionsUtil = h;
 var g = (function () {
     function a(n, p) {
         if (((this._env = n), (this.options = h.mergeConfigurationOptions(p)), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(), this._createSortedPathsRules(), this.options.baseUrl === "")) {
     ...
     return (
         ...
         (a.prototype._createSortedPathsRules = function () {
             ...
             (this.sortedPathsRules = []),
                 f.Utilities.forEachProperty(this.options.paths, function (p, r) {
                     Array.isArray(r) ? n.sortedPathsRules.push({ from: p, to: r }) : n.sortedPathsRules.push({ from: p, to: [r] });
                 }),
         ...
         (a.prototype._applyPaths = function (n) {
             for (var p, r = 0, e = this.sortedPathsRules.length; r < e; r++)
                 if (((p = this.sortedPathsRules[r]), f.Utilities.startsWith(n, p.from))) {
         ...
         (a.prototype._addUrlArgsToUrl = function (n) {
             return f.Utilities.containsQueryString(n) ? n + "&" + this.options.urlArgs : n + "?" + this.options.urlArgs;
         }),
         ...
         (a.prototype.moduleIdToPaths = function (n) {
             var p = this.nodeModulesMap[n] === !0 || (this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(n));
             if (p) return this.isBuild() ? ["empty:"] : ["node|" + n];
             var r = n,
                 e;
             if (!f.Utilities.endsWith(r, ".js") && !f.Utilities.isAbsolutePath(r)) {
                 e = this._applyPaths(r);
                 for (var t = 0, i = e.length; t < i; t++)
                     (this.isBuild() && e[t] === "empty:") ||
                         (f.Utilities.isAbsolutePath(e[t]) || (e[t] = this.options.baseUrl + e[t]), !f.Utilities.endsWith(e[t], ".js") && !f.Utilities.containsQueryString(e[t]) && (e[t] = e[t] + ".js"));
             } else !f.Utilities.endsWith(r, ".js") && !f.Utilities.containsQueryString(r) && (r = r + ".js"), (e = [r]);
             return this._addUrlArgsIfNecessaryToUrls(e);
         }),
         (a.prototype.requireToUrl = function (n) {
             var p = n;
             return f.Utilities.isAbsolutePath(p) || ((p = this._applyPaths(p)[0]), f.Utilities.isAbsolutePath(p) || (p = this.options.baseUrl + p)), this._addUrlArgsIfNecessaryToUrl(p);
         }),
...
(function (f) {
         ...
         return (
             (r.prototype.load = function (e, t, i, o) {
                 ...
                 if (!this._scriptLoader)
                     if (this._env.isWebWorker) this._scriptLoader = new g();
                     else if (this._env.isElectronRenderer) {
                         var s = e.getConfig().getOptionsLiteral().preferScriptTags;
                         s ? (this._scriptLoader = new h()) : (this._scriptLoader = new a(this._env));
                     } else this._env.isNode ? (this._scriptLoader = new a(this._env)) : (this._scriptLoader = new h());
                 var l = { callback: i, errorback: o };
                 if (this._callbackMap.hasOwnProperty(t)) {
                     this._callbackMap[t].push(l);
                     return;
                 }
                 (this._callbackMap[t] = [l]),
             ...
             (r.prototype.load = function (e, t, i, o) {
                 if (/^node\|/.test(t)) {
                     var u = e.getConfig().getOptionsLiteral(),
                         s = n(e.getRecorder(), u.nodeRequire || f.global.nodeRequire),
                         l = t.split("|"),
                         c = null;
                     try {
                         c = s(l[1]);
                     ...
                     var _ = e.getConfig().getOptionsLiteral().cspNonce;
                     _ && d.setAttribute("nonce", _), document.getElementsByTagName("head")[0].appendChild(d);
                 }
             }),
             r
         );
         ...
         return (
             (r.prototype.load = function (e, t, i, o) {
                 var u = e.getConfig().getOptionsLiteral().trustedTypesPolicy,
                     s = /^((http:)|(https:)|(file:))/.test(t) && t.substring(0, self.origin.length) !== self.origin;
                 if (!s) {
                     fetch(t)
                         .then(function (l) {
                         ...
                         .then(function (l) {
                             l =
                                 l + '//# sourceURL=' + t;
                             var c = u ? self.eval(u.createScript("", l)) : new Function(l);
                             c.call(self), i();
                         })
                         .then(void 0, o);
                     return;
                 ...
                 try {
                     u && (t = u.createScriptURL(t)), importScripts(t), i();
                 } catch (l) {
                     o(l);
                 }
             }),
         ...
         return (
             ...
             (r.prototype._initNodeRequire = function (e, t) {
                 ...
                 if (!!i && !this._didPatchNodeRequire) {
                     ...
                     function s(l) {
                         ...
                         return (
                             (d.resolve = function (_, y) {
                                 return c._resolveFilename(_, l, !1, y);
                             }),
                             (d.resolve.paths = function (_) {
                                 return c._resolveLookupPaths(_, l);
                             }),
                     ...
                     u.prototype._compile = function (l, c) {
                         var d = u.wrap(l.replace(/^#!.*/, "")),
                             v = t.getRecorder(),
                             _ = o._getCachedDataPath(i, c),
                             y = { filename: c },
                             m;
                         try {
                             var I = o._fs.readFileSync(_);
                             (m = I.slice(0, 16)), (y.cachedData = I.slice(16)), v.record(60, _);
                         } catch (O) {
                             v.record(61, _);
                         }
                         var b = new o._vm.Script(d, y),
                             ...
                             P = o._path.dirname(c),
                             U = s(this),
                             w = [this.exports, U, this, c, P, process, _commonjsGlobal, Buffer],
                             R = C.apply(this.exports, w);
                         return o._handleCachedData(b, d, _, !y.cachedData, t), o._verifyCachedData(b, d, _, m, t), R;
                     };
                 }
             }),
             (r.prototype.load = function (e, t, i, o) {
                 var u = this,
                     ...
                     l = n(e.getRecorder(), s.nodeRequire || f.global.nodeRequire),
                     c =
                         s.nodeInstrumenter ||
                         function (C) {
                             return C;
                         };
                 this._init(l), this._initNodeRequire(l, e);
                 var d = e.getRecorder();
                 if (/^node\|/.test(t)) {
                     var v = t.split("|"),
                         _ = null;
                     ...
                     t = f.Utilities.fileUriToFilePath(this._env.isWindows, t);
                     ...
                     this._readSourceAndCachedData(y, b, d, function (C, P, U, w) {
                         ...
                         var R;
                         P.charCodeAt(0) === r._BOM ? (R = r._PREFIX + P.substring(1) + r._SUFFIX) : (R = r._PREFIX + P + r._SUFFIX), (R = c(R, y));
                         var O = { filename: m, cachedData: U },
                             M = u._createAndEvalScript(e, R, O, i, o);
                         u._handleCachedData(M, R, b, I && !U, e), u._verifyCachedData(M, R, b, w, e);
                     });
                 }
             }),
             (r.prototype._createAndEvalScript = function (e, t, i, o, u) {
                 ...
                 var l = new this._vm.Script(t, i),
                     c = l.runInThisContext(i),
                 ...
                 return (
                     (_.amd = d.amd), c.call(f.global, e.getGlobalAMDRequireFunc(), _, i.filename, this._path.dirname(i.filename)), s.record(32, i.filename), v ? o() : u(new Error("Didn't receive define call in " + i.filename + "!")), l
                 );
             }),
             ...
             (r.prototype._getCachedDataPath = function (e, t) {
                 var i = this._crypto.createHash("md5").update(t, "utf8").update(e.seed, "utf8").update(process.arch, "").digest("hex"),
             ...
             (r.prototype._handleCachedData = function (e, t, i, o, u) {
                 ...
                 e.cachedDataRejected
                     ? this._fs.unlink(i, function (l) {
                           u.getRecorder().record(62, i), s._createAndWriteCachedData(e, t, i, u), l && u.getConfig().onError(l);
                       })
                     : o && this._createAndWriteCachedData(e, t, i, u);
             }),
             (r.prototype._createAndWriteCachedData = function (e, t, i, o) {
                 var u = this,
                     s = Math.ceil(o.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())),
                     l = -1,
                     c = 0,
                     d = void 0,
                     v = function () {
                         setTimeout(function () {
                             ...
                             var _ = e.createCachedData();
                             if (!(_.length === 0 || _.length === l || c >= 5)) {
                                 if (_.length < l) {
                                     v();
                                     return;
                                 }
                                 (l = _.length),
                                     u._fs.writeFile(i, Buffer.concat([d, _]), function (y) {
             ...
             (r.prototype._readSourceAndCachedData = function (e, t, i, o) {
                 if (!t) this._fs.readFile(e, { encoding: "utf8" }, o);
                     ...
                     var u = void 0,
                         ...
                         c = 2,
                         d = function (v) {
                             v ? o(v) : --c == 0 && o(void 0, u, s, l);
                         };
                     this._fs.readFile(e, { encoding: "utf8" }, function (v, _) {
                         (u = _), d(v);
                     }),
                         this._fs.readFile(t, function (v, _) {
                             !v && _ && _.length > 0 ? ((l = _.slice(0, 16)), (s = _.slice(16)), i.record(60, t)) : i.record(61, t), d();
                         });
                 }
             }),
             (r.prototype._verifyCachedData = function (e, t, i, o, u) {
                 ...
                 !o ||
                     e.cachedDataRejected ||
                     setTimeout(function () {
                         var l = s._crypto.createHash("md5").update(t, "utf8").digest();
                         o.equals(l) ||
                             (u.getConfig().onError(new Error("FAILED TO VERIFY CACHED DATA, deleting stale '" + i + "' now, but a RESTART IS REQUIRED")),
 ...
 f.ensureRecordedNodeRequire = n;
 function p(r) {
     return new E(r);
 }
 f.createScriptLoader = p;
})(AMDLoader || (AMDLoader = {}));
var AMDLoader;
(function (f) {
 var E = (function () {
     ...
     return (
         ...
         (r.prototype.resolveModule = function (e) {
             var t = e;
             return f.Utilities.isAbsolutePath(t) || ((f.Utilities.startsWith(t, "./") || f.Utilities.startsWith(t, "../")) && (t = r._normalizeModuleId(this.fromModulePath + t))), t;
         }),
         (r.ROOT = new r("")),
         r
     );
 })();
 f.ModuleIdResolver = E;
 var h = (function () {
     ...
     return (
         (r._safeInvokeFunction = function (e, t) {
             try {
                 return { returnedValue: e.apply(f.global, t), producedError: null };
             } catch (i) {
                 return { returnedValue: null, producedError: i };
             }
         }),
         (r._invokeFactory = function (e, t, i, o) {
             return e.isBuild() && !f.Utilities.isAnonymousModule(t) ? { returnedValue: null, producedError: null } : e.shouldCatchError() ? this._safeInvokeFunction(i, o) : { returnedValue: i.apply(f.global, o), producedError: null };
         }),
         (r.prototype.complete = function (e, t, i) {
             ...
             if (this._callback)
                 if (typeof this._callback == "function") {
                     ...
                     (o = u.producedError), e.record(22, this.strId), !o && typeof u.returnedValue != "undefined" && (!this.exportsPassedIn || f.Utilities.isEmpty(this.exports)) && (this.exports = u.returnedValue);
                 } else this.exports = this._callback;
             if (o) {
                 var s = f.ensureError(o);
                 (s.phase = "factory"), (s.moduleId = this.strId), (this.error = s), t.onError(s);
             }
 ...
 var p = (function () {
     ...
     return (
             ...
             for (
                 ...
                 if (l) {
                     var c = l[1],
                         d = l[2],
                         v = l[3],
                         _ = Math.max(c.lastIndexOf(" ") + 1, c.lastIndexOf("(") + 1);
                     if (((c = c.substr(_)), (c = i(c)), c === o)) {
                         var y = { line: parseInt(d, 10), col: parseInt(v, 10) };
                         return y.line === 1 && (y.col -= "(function (require, define, __filename, __dirname) { ".length), y;
                     }
                 }
             }
             ...
             for (var e = [], t = 0, i = 0, o = this._modules2.length; i < o; i++) {
                 ...
                 if (!!u) {
                     var s = this._buildInfoPath[u.id] || null,
                         l = this._buildInfoDefineStack[u.id] || null,
                         c = this._buildInfoDependencies[u.id];
                     e[t++] = { id: u.strId, path: s, defineLocation: s && l ? r._findRelevantLocationInStack(s, l) : null, dependencies: c, shim: null, exports: u.exports };
                 }
             }
             return e;
         }),
         (r.prototype.getRecorder = function () {
             return this._recorder || (this._config.shouldRecordStats() ? (this._recorder = new f.LoaderEventRecorder(this._loaderAvailableTimestamp)) : (this._recorder = f.NullLoaderEventRecorder.INSTANCE)), this._recorder;
         }),
         ...
         (r.prototype.enqueueDefineAnonymousModule = function (e, t) {
             ...
             var i = null;
             this._config.isBuild() && (i = new Error("StackLocation").stack || null), (this._currentAnnonymousDefineCall = { stack: i, dependencies: e, callback: t });
         }),
             ...
             (this._modules2[c] = d),
                 this._config.isBuild() &&
                     ...
                     (this._buildInfoDependencies[c] = (d.dependencies || []).map(function (v) {
                         return l._moduleIdProvider.getStrModuleId(v.id);
                     }))),
                 this._resolve(d);
         }),
         (r.prototype._normalizeDependency = function (e, t) {
             ...
             if (i >= 0) {
                 var o = t.resolveModule(e.substr(0, i)),
                     ...
                     l = this._moduleIdProvider.getModuleId(o);
                 return new n(s, l, u);
             }
         ...
         (r.prototype._relativeRequire = function (e, t, i, o) {
             ...
             this.defineModule(f.Utilities.generateAnonymousModule(), t, i, o, null, e);
         }),
         ...
         (r.prototype.configure = function (e, t) {
             ...
             t ? (this._config = new f.Configuration(this._env, e)) : (this._config = this._config.cloneAndMerge(e)), this._config.shouldRecordStats() && !i && (this._recorder = null);
         }),
         ...
         (r.prototype._createLoadError = function (e, t) {
             var i = this,
                 ...
                 u = (this._inverseDependencies2[e] || []).map(function (l) {
                     return i._moduleIdProvider.getStrModuleId(l);
                 }),
                 s = f.ensureError(t);
         ...
         (r.prototype._onLoadError = function (e, t) {
             ...
             for (c.push(e), o[e] = !0; c.length > 0; ) {
                 var d = c.shift(),
                     v = this._modules2[d];
                 v && (l = v.onDependencyError(i) || l);
                 var _ = this._inverseDependencies2[d];
                 if (_)
                     for (var u = 0, s = _.length; u < s; u++) {
                         var y = _[u];
                         o[y] || (c.push(y), (o[y] = !0));
                     }
             }
             l || this._config.onError(i);
         }),
             ...
             for (l.push(i), o[e] = !0; l.length > 0; ) {
                 ...
                 if (d)
                     for (var u = 0, s = d.length; u < s; u++) {
                         var v = d[u];
                         if (v.id === t) return !0;
                         var _ = this._modules2[v.id];
                         _ && !o[v.id] && ((o[v.id] = !0), l.push(_));
                     }
             }
             return !1;
         }),
         ...
         (r.prototype._createRequire = function (e) {
             ...
             return (
                 ...
                 (i.__$__nodeRequire = f.global.nodeRequire),
                 i
             );
         }),
         (r.prototype._loadModule = function (e) {
             ...
             if (!(this._modules2[e] || this._knownModules2[e])) {
                 ...
                 var i = this._moduleIdProvider.getStrModuleId(e),
                     ...
                     u = /^@[^\/]+\/[^\/]+$/;
                 this._env.isNode && (i.indexOf("/") === -1 || u.test(i)) && o.push("node|" + i);
                 var s = -1,
                     l = function (c) {
                         if ((s++, s >= o.length)) t._onLoadError(e, c);
                             ...
                             if (t._config.isBuild() && d === "empty:") {
                                 (t._buildInfoPath[e] = d), t.defineModule(t._moduleIdProvider.getStrModuleId(e), [], null, null, null), t._onLoad(e);
                                 return;
                             }
                             v.record(10, d),
         ...
         (r.prototype._resolve = function (e) {
             ...
             if (i)
                 for (var o = 0, u = i.length; o < u; o++) {
                     ...
                     var l = this._modules2[s.id];
                     if (l && l.isComplete()) {
                         if (l.error) {
                             e.onDependencyError(l.error);
                             return;
                         }
                         e.unresolvedDependenciesCount--;
                         continue;
                     ...
                     if (this._hasDependencyPath(s.id, e.id)) {
                         (this._hasDependencyCycle = !0),
                             console.warn("There is a dependency cycle between '" + this._moduleIdProvider.getStrModuleId(s.id) + "' and '" + this._moduleIdProvider.getStrModuleId(e.id) + "'. The cyclic path follows:");
                         var c = this._findCyclePath(s.id, e.id, 0) || [];
                         c.reverse(),
                             c.push(s.id),
                             console.warn(
                                 c.map(function (_) {
                                     return t._moduleIdProvider.getStrModuleId(_);
                                 }).join(' => ')
                             ),
                             e.unresolvedDependenciesCount--;
                         continue;
                     }
                     if (((this._inverseDependencies2[s.id] = this._inverseDependencies2[s.id] || []), this._inverseDependencies2[s.id].push(e.id), s instanceof n)) {
                         ...
                         v || ((v = []), this._inversePluginDependencies2.set(s.pluginId, v)), v.push(s), this._loadModule(s.pluginId);
                         continue;
                     }
             ...
             if (!e.isComplete()) {
                 ...
                 if (((this._inverseDependencies2[e.id] = null), v))
                     for (var s = 0, l = v.length; s < l; s++) {
                         var _ = v[s],
                             y = this._modules2[_];
                         y.unresolvedDependenciesCount--, y.unresolvedDependenciesCount === 0 && this._onModuleComplete(y);
                     }
                 var m = this._inversePluginDependencies2.get(e.id);
                 if (m) {
                     this._inversePluginDependencies2.delete(e.id);
                     for (var s = 0, l = m.length; s < l; s++) this._loadPluginDependency(e.exports, m[s]);
                 }
             }
         }),
         r
...
(function (f) {
 ...
 var a = function (r, e) {
     ...
     n = function () {
         if (arguments.length === 1) {
             ...
             if (typeof arguments[0] == "string") return h.synchronousRequire(arguments[0]);
         }
         if ((arguments.length === 2 || arguments.length === 3) && Array.isArray(arguments[0])) {
             h.defineModule(f.Utilities.generateAnonymousModule(), arguments[0], arguments[1], arguments[2], null);
             return;
         }
 ...
 function p() {
     if (typeof f.global.require != "undefined" || typeof require != "undefined") {
         var r = f.global.require || require;
         if (typeof r == "function" && typeof r.resolve == "function") {
             var e = f.ensureRecordedNodeRequire(h.getRecorder(), r);
             (f.global.nodeRequire = e), (n.nodeRequire = e), (n.__$__nodeRequire = e);
         }
     }
     E.isNode && !E.isElectronRenderer ? ((module.exports = n), (require = n)) : (E.isElectronRenderer || (f.global.define = g), (f.global.require = n));
 }
 (f.init = p),
     (typeof f.global.define != "function" || !f.global.define.amd) &&
         ((h = new f.ModuleManager(E, f.createScriptLoader(E), g, n, f.Utilities.getHighPerformanceTimestamp())),
         typeof f.global.require != "undefined" && typeof f.global.require != "function" && n.config(f.global.require),
         (define = function () {
             return g.apply(null, arguments);
         }),
         (define.amd = g.amd),
